...
(function(){
	function init(options){
		var target=Elf.controls.createElement("div","elf-banner");
	...
	Elf.utils.extend(Elf.components,{
        banner:function(options,params){
            if (typeof options == 'string'){
                return Elf.components.banner.methods[options](params);
            }
            var me=Elf.controls.createElement("div","elf-banner");
            options = Elf.utils.extend({},Elf.components.banner.defaults,options);
            return init(options);
        }
    });
    Elf.components.banner.defaults={
		width:"",
		height:"",
		autoPlay:0,
		prev:"",
