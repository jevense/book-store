...
(function(){
    ...
    function setCurrent(target,currentItem){
        ...
        if(Elf.utils.hasClass(currentItem,"fold")){
            ...
            }else if(typeof Elf.components.accordionNav.defaults.onClick=="function"){
                Elf.components.accordionNav.defaults.onClick.call(target,currentItem);
            }
        }
    }
            ...
            if(item){
                if(Elf.utils.hasClass(item,"fold")){
                    ...
                    if(typeof opts.onClick=="function"){
                        ...
                        Elf.components.accordionNav.defaults.onClick.call(target,item);
                    }
                }
            }
        });
