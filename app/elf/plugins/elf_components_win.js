/**
 * Created by lijianwei on 2017/1/17.
 */
/**
...
(function(){
    ...
    Elf.utils.extend(Elf.components,{
        win:function(options,params){
            if (typeof options == 'string'){
                return Elf.components.win.methods[options](params);
            }
            ...
            },Elf.components.win.defaults,options);
            me.options=options;
            init(me,params);
            return me;
        }
    });
    Elf.components.win.defaults={};
    Elf.components.win.methods ={
