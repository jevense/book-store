...
Elf.xEvents.eventDispatcher=function(obj){
    ...
    if(Elf.terminalInfo.IsMobile){
        ...
        obj.touchStartAction=function (event) {
        ...
        obj.addEventListener("touchstart",obj.touchStartAction);
        obj.touchMoveAction=function (event) {
            //event.preventDefault();
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            //Elf.xEvents.stopPop(event);
...
//            obj.isTouchMoving=true;
        ...
        obj.addEventListener("touchmove", obj.touchMoveAction);
        obj.touchEndAction=function (event) {
            //event.preventDefault();
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            //Elf.xEvents.stopPop(event);
...
//            alert(remainFingersCount);
        ...
        obj.addEventListener("touchend", obj.touchEndAction);
    }
    else{
        obj.starts = [];
        obj.mouseDownMoves = [];
        ...
        obj.mouseDownAction=function (event) {
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            var startInfo={};
            startInfo.x=e.pageX;
        ...
        obj.addEventListener("mousedown", obj.mouseDownAction);
        obj.mouseMoveAction=function (event) {
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            if(obj.IsMouseDown){
                var moveInfo={};
        ...
        obj.addEventListener("mousemove", obj.mouseMoveAction);
        obj.mouseUpAction=function (event) {
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            var endInfo={};
            endInfo.x=e.pageX;
        ...
        obj.addEventListener("mouseup",obj.mouseUpAction);
        obj.mouseScrollAction=function (event) {// Firefox scroll
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            //Elf.xEvents.stopPop(event);
        ...
        obj.addEventListener("DOMMouseScroll", obj.mouseScrollAction);
        obj.mouseWheelAction=function (event) {// Others scroll
            var e = Elf.getEvent(event);
            Elf.stopPop(e);
            //Elf.xEvents.stopPop(event);
        ...
        obj.addEventListener("mousewheel", obj.mouseWheelAction);
    }
};
Elf.xEvents.unBindCommonEvent=function(obj){
    obj.isDispatcherBinded=false;
    if(Elf.terminalInfo.IsMobile){
        obj.removeEventListener("touchstart",obj.touchStartAction);
        obj.removeEventListener("touchmove",obj.touchMoveAction);
        obj.removeEventListener("touchend",obj.touchEndAction);
    }
    else{
        obj.removeEventListener("mousedown",obj.mouseDownAction);
        obj.removeEventListener("mousemove",obj.mouseMoveAction);
        obj.removeEventListener("mouseup",obj.mouseUpAction);
        obj.removeEventListener("DOMMouseScroll",obj.mouseScrollAction);
        obj.removeEventListener("mousewheel",obj.mouseWheelAction);
    }
};
...
Elf.xEvents.onXDragging = function (obj, action,end) {
    obj.draggingAction=action;
    obj.addEventListener("xDragging",obj.draggingAction);
    obj.dragEndAction=end;
    obj.addEventListener("xDragEnd",obj.dragEndAction);
    Elf.xEvents.bindDispatcher(obj);
};
Elf.xEvents.removeXDragging = function (obj) {
    obj.removeEventListener("xDragging",obj.draggingAction);
    obj.removeEventListener("xDragEnd",obj.dragEndAction);
    Elf.xEvents.unBindCommonEvent(obj);
};
/*
...
Elf.xEvents.bind=function(el,types,handler){
    ...
    switch (types) {
        ...
        default:
            types=types.split(" ");
            Elf.each(types,function(type,index){
